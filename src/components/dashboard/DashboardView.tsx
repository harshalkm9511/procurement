...
export const DashboardView: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      {/* Header Banner */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-blue-950/40 via-slate-900 to-slate-950 p-6 rounded-3xl border border-slate-800 shadow-xl relative overflow-hidden">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Here is your procurement intelligence overview.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-semibold text-xs shadow-lg shadow-cyan-500/20 flex items-center gap-2 transition-all transform hover:scale-[1.02]"
          >
            <Sparkles className="w-4 h-4 text-cyan-200" />
            <span>Ask ProcureAI Assistant</span>
          </button>
        </div>
      </div>
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-semibold text-cyan-300 uppercase tracking-wider flex items-center gap-1">
              <Sparkles className="w-3.5 h-3.5 text-cyan-400 animate-pulse" /> Potential Savings
            </span>
